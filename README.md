...
| `LLM_API_KEY` / `LLM_BASE_URL` / `LLM_MODEL` | — / https://opencode.ai/zen/go/v1 / mimo-v2.5 | AI analysis provider (OpenAI-compatible, OpenCode Go subscription). Usage limits: https://opencode.ai/docs/go/#usage-limits |
